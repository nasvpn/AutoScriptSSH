...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/kevindoni/AutoScriptSSH/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/kevindoni/AutoScriptSSH/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
